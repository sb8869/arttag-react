  ...
  return (
      <div className="paint-app">
          <div className='top-tools'>
            ...
            <button class="toolButton"><img src={redo} width="auto" id="save-button"/></button>
            <button class="toolButton"><img src={done} width="auto" id="save-button"/></button>
            <button class="toolButton"><img src={undo} width="auto" id="save-button"/></button>
