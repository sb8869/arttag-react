...
export default (props) => {
	...
	const draw = (p5) => {
        ...
        if (p5.mouseIsPressed) {
            ...
            if (type === 'marker') {
                this.marker(color, brushWidth.value(), p5);
            } else if (type === 'spray') {
                this.sprayPaint(color, brushWidth.value(), p5)
            } else if (type === 'fountain') {
                this.fountainPen(color, brushWidth.value(), p5);
            } else {
                this.pen(color, brushWidth.value(), p5);
            }
        }
    };
