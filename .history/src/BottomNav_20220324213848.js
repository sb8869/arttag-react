...
function BottomNav() {
  ...
  return (
      <div className="bottombar-nav">
        <div className="row">
            <Link><button><img src={`${qr}`} style= {{ width: '50%',  marginLeft: 'auto', marginRight: 'auto', display: 'block'}} alt="navigateButton"/></button></Link>

          <button onClick={() => setButtonPopup(true)}><img src={`${add}`} style= {{ width: '50%'}} alt="navigateButton"/></button>
