	...
	return(
        <div className="paint-app">
            <div className='top-tools'>
                ...
                <button onClick={() => setBackButtonPopup(true)}><img src={back} width="auto"/></button>
                <div id="draw-backbtn">
                <Popup trigger={backButtonPopup} setTrigger={setBackButtonPopup}>
                    <p>Do you want to lose this masterpiece?</p>
                    <Link to="/explore"><button className="toolButton"><img src={`${returnToHome}`} style= {{ width: '100%'}} alt="createButton" id="back-button"/></button></Link>
                </Popup>
                </div>
                ...
                <button className="toolButton" onClick={resetSketch}><img src={trash} width="auto" id="trash-button"/></button>
                    ...
                    >
                        <span className="brushes">
                            <img class="brushImg" src={fountain}></img>
                            <img class="brushImg" src={markerBrush}></img>
                            <img class="brushImg" src={pencil}></img>
                            <img class="brushImg" src={spray} style= {{ width: '10%', paddingBottom: "6%"}}></img>
                        </span>
                    </div>
                    )}
