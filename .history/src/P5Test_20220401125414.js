...
export default (props) => {
    ...
    const saveSketch = p5 => {
        p5.saveCanvas(cnv, "yourSketch", "png");
        console.log("saved")
    }
        ...
        <div className="paint-app">
            <div className='top-tools'>
                ...
                <Popup trigger={saveButtonPopup} setTrigger={setSaveButtonPopup}>
                    <Link to="/drawingApp"><button onClick={saveSketch}><img src={`${saveToGallery}`} style= {{ width: '100%'}} alt="createButton"/></button></Link>
