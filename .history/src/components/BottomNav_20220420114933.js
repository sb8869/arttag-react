...
function BottomNav() {
  ...
  return (
      <div className="bottombar-nav">
          <Link to="/scan"><button><img src={`${qr}`} style= {{ width: '50%'}} alt="navigateButton"/></button></Link>
          ...
          <Popup trigger={buttonPopup} setTrigger={setButtonPopup}>
            ...
            <Link to="/gallery"><button><img src={`${tag}`} id="popup-tab" alt="scanButton"/></button></Link>
          </Popup>
