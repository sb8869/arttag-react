    ...
    return (
        <div className="paint-app">
            <div className='top-tools'>
              <button className="toolButton" onClick={() => this.state.setSaveButtonPopup = true}><img src={save} width="auto" id="save-button"/></button>
              <Popup trigger={saveButtonPopup} setTrigger={this.setState({setSaveButtonPopup = true})}>
