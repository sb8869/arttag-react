                ...
                <button className="toolButton" onClick={resetSketch}><img src={trash} width="auto" id="trash-button"/></button>
                    ...
                    >
                        <span className="brushes">
                            <img className="brushImg" src={fountain} onClick={()=>{console.log("fountain"); type = "fountain"; fountainPen(); unsafe_p5Instance.noErase();}}></img>
                            <img className="brushImg" src={markerBrush} onClick={()=>{console.log("marker"); type = "marker"; marker(); unsafe_p5Instance.noErase();}}></img>
                            <img className="brushImg" src={pencil} onClick={()=>{console.log("pen"); type = "pen"; pen(); unsafe_p5Instance.noErase();}}></img>
                            <img className="brushImg" src={spray} onClick={()=>{console.log("sprat"); type = "spray"; sprayPaint(); unsafe_p5Instance.noErase();}} style= {{ width: '10%', paddingBottom: "6%"}}></img>
                        </span>
                        <input
                            type="range"
                            min="1"
