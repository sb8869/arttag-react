...
onItemsSelect = (item) => {
  ...
  render() {
    ...
    // this.state = {saveButtonPopup: false}
    // function togglePopup() {
    //     this.setState({
    //         saveButtonPopup: !this.state.saveButtonPopup
    //     });
    // }
    ...
    //this.state.backButtonPopup = {backButtonPopup: false}
    return (
        <div className="paint-app">
      
        <div className='top-tools'>
          {/* <button className="toolButton" onClick={() => this.togglePopup}><img src={save} width="auto" id="save-button"/></button> */}
          <button onClick={()=> {this.onItemseSelect(item); togglePopup;}}>show popup</button>
          {this.state.showPopup ? <Popup text='Close Me' closePopup={togglePopup}/> : null
}
          {/* <Popup trigger={!this.state.saveButtonPopup} setTrigger={this.state.saveButtonPopup}>
          ...
          <button onClick={() => this.state.backButtonPopup}><img src={back} width="auto" id="save-button"/></button>
          {/* <Popup trigger={this.state.backButtonPopup} setTrigger={!this.state.backButtonPopup}>
        ...
        <div className='bottom-tools'>
          <button className="toolButton" onClick={this.resetSketch}><img src={trash} width="auto" id="trash-button"/></button>
